...
class CrowsPairsDataset(Dataset):
    ...
    def collate_fn(self, batch):
        ...
        rephrase_trg = [b["rephrase_target"] for b in batch]
        ...
        edit_rephrase["labels"] = self.get_edit_labels(batches["rephrase_trg_input_ids"])
    ...
    def collate_gpt_fn(self, batch):
        ...
        rephrase = [rephrase_ + trg_ for rephrase_, trg_ in zip(rephrase, rephrase_trg)]
